...
y.o.1 <- splinefun(x=seq(0, 8, 1),
                     y=c(0, 0, 0, 0.01, 0.03, 0.2, 0.8, 1.38, 0))(x.o.1)
...
# other curves
x.o.1 <- seq(0, 3, 0.05)
y.o.1 <- splinefun(x=seq(0, 3, 0.5),
                   y=c(0, 0, 0, 0, 0, 0, 0))(x.o.1)

x.o.2 <- seq(3, 3.6, 0.05)
y.o.2 <- splinefun(x=c(3, 3.3, 3.6),
                   y=c(0, 1, 0))(x.o.2)

x.o.3 <- seq(3.6, 10, 0.05)
y.o.3 <- splinefun(x=c(3.6, 4, 5, 6, 7, 8, 9, 10),
                   y=c(0, 0, 0, 0, 0, 0, 0, 0))(x.o.3)
